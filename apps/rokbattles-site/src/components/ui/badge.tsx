...
type BadgeButtonLinkProps = BadgeProps &
...
export const BadgeButton = forwardRef<HTMLElement, BadgeButtonLinkProps | BadgeButtonProps>(
  function BadgeButton(props, ref) {
    const { color = "zinc", className, children } = props;
    ...
    if ("href" in props && props.href) {
      const { href, ...rest } = props as BadgeButtonLinkProps;
      return (
        <Link
          {...rest}
          href={href}
    ...
    const rest = props as BadgeButtonProps;
    return (
