...
export interface TerritoryResourcePoint { id: number; kind: TerritoryResourceKind; x: number; y: number }
export interface TerritoryLandmark { id: number; kind: TerritoryLandmarkKind; x: number; y: number }
export interface TerritoryStructure {
    ...
    y: number;
    label: string;
    collision: { shape: "world-square"; halfSize: number } | { shape: "territory-square"; radiusInCells: number };
