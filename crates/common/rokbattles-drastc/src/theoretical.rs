...
pub const SOC_RAGE_TABLE: RageTable = &[
    ...
    RagePairing::new(540, 619, 7.5),
    RagePairing::new(575, 619, 7.8),
    RagePairing::new(619, 575, 7.8),
    RagePairing::new(619, 576, 7.7),
    RagePairing::new(579, 619, 7.9),
