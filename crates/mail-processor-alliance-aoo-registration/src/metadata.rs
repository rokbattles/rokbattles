//! Metadata parser for AllianceAOORegistration mail.

use mail_processor_sdk::{ExtractError, Extractor, Section, extract_base_metadata};
use serde_json::Value;

/// Pulls top-level metadata out of an AllianceAOORegistration mail.
...
mod tests {
    ...
    fn roundtrip_metadata_extracts_sample() {
        ...
        let fields = section.fields();
        assert_eq!(fields["mail_id"], json!("108726086177768046031"));
        assert_eq!(fields["mail_receiver"], json!("player_71738515"));
        assert_eq!(fields["server_id"], json!(2));
        assert_eq!(fields["mail_time"], json!(1777680460640097u64));
    }
}
