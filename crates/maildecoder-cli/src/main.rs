//! maildecoder-cli: minimal convenience/debugging CLI for the Rise of Kingdoms mail decoder.
//!
...
//!
//! Usage:
//!   maildecoder-cli <file>
//!
//! Behavior:
//! - Reads the entire file into memory,
//! - Decodes it using the maildecoder library,
...
fn main() -> Result<()> {
    ...
    let path = env::args()
        .nth(1)
        .context("usage: maildecoder-cli <file>")?;
    ...
    let value = maildecoder::decode(&bytes)
