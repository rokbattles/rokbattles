import type { TerritoryProvinceGrid } from "@/autogenerated/container/rokbattles_container";
...
export type ProvinceRestrictionGrid = Omit<
  TerritoryProvinceGrid,
  "flagBlocked" | "fortressBlocked"
> & {
