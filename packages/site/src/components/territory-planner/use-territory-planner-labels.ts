...
import type { PlannerTool, TerritoryMapIndexRow } from "@/lib/territory/types";

export function useTerritoryPlannerLabels() {
  const t = useExtracted();
  const resourceLabels: Record<TerritoryResourceKind, string> = {
    food: t("Food"),
    wood: t("Wood"),
    stone: t("Stone"),
    coin: t("Gold"),
  ...
  return {
    ...
    resourceLabel: (kind: TerritoryResourceKind) => resourceLabels[kind],
